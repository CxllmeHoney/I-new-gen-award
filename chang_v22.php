        ...
        if (navigator.geolocation) {
          navigator.geolocation.getCurrentPosition(
            (position) => {
              ...
              directionsRenderer = new google.maps.DirectionsRenderer({
                map: map,
                suppressMarkers: true, // ปิดการแสดงมาร์กเกอร์ A/B เริ่มต้น
              });
              // เพิ่มมาร์กเกอร์แบบกำหนดเองสำหรับเส้นทาง
              const carIcon = {
                url: "https://cdn-icons-png.flaticon.com/128/2555/2555013.png", // ใช้ไอคอนรถจาก Google
              ...
              // อัปเดตการแสดงเส้นทางให้ใช้มาร์กเกอร์แบบกำหนดเอง
              directionsService.route(request, (result, status) => {
                if (status === "OK") {
