...
<html lang="th">
  ...
  <body>
    ...
    <script>
        ...
        if (navigator.geolocation) {
          ...
          watchId = navigator.geolocation.watchPosition(
            (position) => {
              ...
              // คำนวณและแสดงเส้นทาง
              calculateAndDisplayRoute(userPos, { lat: destLat, lng: destLng });
            },
            (error) => {
      ...
      function displayNavigationInfo(result) {
        ...
        <div style="padding: 15px;">
            <h3 style="margin: 0 0 15px 0;">ข้อมูลการนำทาง</h3>
    ...
    `;
      ...
      // ฟังก์ชันเพิ่มปุ่มยกเลิกการนำทาง
    ...
    `;
      ...
      // ฟังก์ชันจัดการข้อผิดพลาดการระบุตำแหน่ง
